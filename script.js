...
const apiKeyList = ["AIzaSyBEY3hU4KrgZ4FqS6thCo-zYgWlj2mdDPI", "AIzaSyBoGjblXMVbTwB-pfvHLLhRrsT2XhTOLu4", "AIzaSyDlNfIgFRydJ8mB36DQ8u_LjkiffCSmZmM"];
...
getPlayListItems("PLRPGGQl2fDPBjEpZi-BwaU8pq0zQkffyb")
.then(data => {
	data.forEach(item => {
